...
.Several mapping methods / identical source and target types -> ambiguous mapping method error
====
[source, java, linenums]
[subs="verbatim,attributes"]
----
...
.Declaring a qualifier type & qualifier types / mapping methods
====
[source, java, linenums]
[subs="verbatim,attributes"]
----
